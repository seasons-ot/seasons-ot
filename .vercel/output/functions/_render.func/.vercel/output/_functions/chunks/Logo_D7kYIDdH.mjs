import { c as createAstro, a as createComponent, r as renderTemplate, b as renderComponent, m as maybeRenderHead, e as addAttribute, s as spreadAttributes, F as Fragment } from './astro/server_CHVXW16u.mjs';
import 'kleur/colors';
import { S as SITE } from './permalinks_DJJR2H9b.mjs';
...
}, "C:/Coding/seasons-ot/src/components/common/Image.astro", void 0);

const $$Logo = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<span class="self-center ml-2 rtl:ml-0 rtl:mr-2 text-2xl md:text-xl font-bold text-[#543710] uppercase tracking-wider whitespace-nowrap flex justify-center items-center gap-1"> ${renderComponent($$result, "Image", $$Image, { "class": "mx-auto rounded-md w-full inline", "style": "object-fit: contain;", "widths": [400, 768, 1024, 2040], "sizes": "(max-width: 767px) 400px, (max-width: 1023px) 768px, (max-width: 2039px) 1024px, 2040px", "loading": "eager", "width": 24, "height": 24, "src": "~/assets/images/seasons-ot-logo.png", "alt": "Seasons Occupational Therapy Logo" })} ${SITE?.name} </span>`;
}, "C:/Coding/seasons-ot/src/components/Logo.astro", void 0);
