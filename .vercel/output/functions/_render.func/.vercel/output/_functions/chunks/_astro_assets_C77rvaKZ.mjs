...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      './astro/assets-service_Djo8X02C.mjs'
    ).then(n => n.a1).catch((e) => {
...
}, "C:/Coding/seasons-ot/node_modules/astro/components/Image.astro", void 0);
...
}, "C:/Coding/seasons-ot/node_modules/astro/components/Picture.astro", void 0);
