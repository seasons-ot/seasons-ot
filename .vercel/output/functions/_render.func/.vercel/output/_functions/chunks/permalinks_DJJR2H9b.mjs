...
const SITE = {"name":"Seasons OT","site":"https://astrowind.vercel.app","base":"/","trailingSlash":false,"googleSiteVerificationId":false};
                    const I18N = {"language":"en","textDirection":"ltr"};
                    const METADATA = {"title":{"default":"Seasons OT","template":"%s — AstroWind"},"description":"🚀 Suitable for Startups, Small Business, Sass Websites, Professional Portfolios, Marketing Websites, Landing Pages & Blogs.","robots":{"index":true,"follow":true},"openGraph":{"type":"website","site_name":"Seasons OT","images":[{"url":"~/assets/images/default.png","width":1200,"height":628}]},"twitter":{"handle":"@onwidget","site":"@onwidget","cardType":"summary_large_image"}};
...
export { APP_BLOG as A, BLOG_BASE as B, CATEGORY_BASE as C, I18N as I, METADATA as M, POST_PERMALINK_PATTERN as P, SITE as S, TAG_BASE as T, UI as U, getPermalink as a, getHomePermalink as b, getFormattedDate as c, cleanSlug as d, getCanonical as e, getAsset as f, getBlogPermalink as g, trimSlash as t };
